...
public class CalendarFileWriterTests {
    ...
    public void setup() {
        ...
        if (eventOne == null || eventTwo == null) {
            ...
            eventOne = new CalendarEvent("Spring Begins", eventOneDate,eventOneDate.plusDays(1),false,false,null,null,null,null,"The first day of spring.");
            eventTwo = new CalendarEvent("Tests first written", eventTwoDate,eventTwoDate.plusDays(1),false,false,null,null, null,null,null);
        }
    }
